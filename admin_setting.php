...
?>
	...
	<h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
		<a class="nav-tab <?php if($tab == 'general' || $tab == ''){ echo esc_html( "nav-tab-active" ); } ?>" href="?page=ph_wcqv_quick_view_setting&amp;tab=general">Setting</a>
		<a class="nav-tab <?php if($tab == 'premium'){ echo esc_html( "nav-tab-active" ); } ?>" href="?page=ph_wcqv_quick_view_setting&amp;tab=premium">Premium</a>
	</h2>
	...
	if($tab == 'general' || $tab == '')
	{
					...
					<div class="pho_check_pin">
						<div class="column two">
							...
							<div class="pho-upgrade-btn">
								...
								<a target="blank" href="http://quickview.phoeniixxdemo.com/shop/"><img src="<?php echo $plugin_dir_url; ?>images/button2.png" /></a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="phoe_video_main">
			...
			<iframe width="800" height="360"src="https://www.youtube.com/embed/LQLboeIXmzM" allowfullscreen></iframe>
		</div>
